        ...
        <div className="relative rounded-[3rem] border border-white/10 bg-background/40 backdrop-blur-3xl p-8 sm:p-20 shadow-2xl">
          <div className="mb-20 space-y-6 text-center">
            ...
            <p className="mx-auto max-w-2xl text-xl text-muted-foreground/80 font-light">
              Estoy listo para transformar ideas en productos digitales de alto
              nivel. Contáctame y hablemos de tu próximo proyecto.
            </p>
          </div>
...
function ContactAction({ href, onClick, icon, label, value, copyable }) {
  ...
  return (
    <Component
      ...
      className="group relative flex flex-col gap-3 rounded-[2rem] border border-white/5 bg-white/[0.03] p-8 transition-all hover:bg-white/[0.06] hover:border-white/20 shadow-lg text-left"
    >
